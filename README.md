...
- The Watchers tab adds local “MacB AI” cards for product prices, website text changes, GitHub release tags and system thresholds. Checks run on a quiet schedule, store only the last value/baseline locally, and surface changes in the notch.
