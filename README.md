...
- The Tools tab shows Claude/Codex desktop and terminal activity, CPU/RAM/disk/battery/thermal state, creates and extracts ZIP files, sends audio/video to MacWhisper, finds application leftovers for review, reclaims cache and log folders, and offers a timed keyboard-cleaning lock.
